...
class _CategoryRouteState extends State<CategoryRoute> {
  ...
  // TODO:Done Remove _categoryNames as they will be retrieved from the JSON asset
...
//  ];
  ...
  // TODO:Done Remove the overriding of initState(). Instead, we use
...
//   TODO:Done Uncomment this out. We use didChangeDependencies() so that we can
//   wait for our JSON asset to be loaded in (async).
  ...
  Future<void> _retrieveLocalCategories() async {
    ...
    // TODO:Done Create Categories and their list of Units, from the JSON asset
    var categoryIndex = 0;
  ...
  // TODO:Done Delete this function; instead, read in the units from the JSON asset
